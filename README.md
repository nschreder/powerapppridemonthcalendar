...
4. [Customization](#Customization)
    1. [Logo or background image](#I-want-to-change-the-logo-or-background-image)
    2. [Change content of the pride month calendar](#I-want-to-change-the-content-of-the-pride-month-calendar)
    3. [Change name, description, icon, or background color](#i-want-to-change-the-powerapp-icon-name-description-or-background-color-during-startup)
